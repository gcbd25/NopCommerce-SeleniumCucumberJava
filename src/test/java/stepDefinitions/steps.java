...
import utilities.locator.locatorsCommon;
...
public class steps extends BaseClass{
	...
	public void user_validate_error_message_on_log_in_page() throws WebDriverException, IOException{
		screen.screenshot(logIn.validateErrorMsg(configFileReader.getErrorInLogInPage()) + " Message");
	}
	...
	public void user_validates_an_error_alert_when_form_is_empty() throws WebDriverException, IOException{
		Assert.assertTrue(driver.findElement(locCommon.alertError).getText().contains(configFileReader.getErrorMsgEmptyForm()));
	...
	public void user_validates_error_alert(String alertMsg) throws WebDriverException, IOException {
		Assert.assertTrue(driver.findElement(locCommon.alertError).getText().contains(alertMsg));
		screen.screenshot("Alert Message");
	}
	...
	public void user_validates_error_message_under_email_field(String errorMsg)  throws WebDriverException, IOException {
		Assert.assertTrue(driver.findElement(locAddNewCustomer.errorMsgEmail).getText().contains(errorMsg));
	...
	public void user_validates_success_alert(String alertMsg) throws WebDriverException, IOException{
		Assert.assertTrue(driver.findElement(locCommon.alertSuccess).getText().contains(alertMsg));
		screen.screenshot("Alert Message");
	}
